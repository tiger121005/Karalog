...
//
//    //検索条件に応じて投稿を取得する
//    func getPost(first: Bool, music: String, artist: String, category: [String]) async throws
//        -> [Post]
//    {
...
//                                    if let list = self.convertCollection(
...
//                var list: [Post] = []
//                do {
//                    let gotList = try await self.getPost(
//                        first: first, music: music, artist: artist, category: category)
//                    if gotList.count == 0 {
//                        return []
//                    }
...
//
//                        let gotList = try await self.getPost(
//                            first: false, music: music, artist: artist, category: category)
//
//                        if gotList.count == 0 {
//                            return list
//                        }
...
//
//    //一人のユーザーの投稿を検索する
//    func searchUserPost(first: Bool, id: String, name: String) async -> [Post]? {
...
//
//    func post(
//        musicName: String, artistName: String, musicImage: String, content: String,
//        category: [String]
//    ) {
