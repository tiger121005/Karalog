...
//                UserRef.NoticeRef.content.rawValue:
//                    "\(manager.user.name)さん（ユーザーID: \(String(userID))）からフォローリクエストが届きました",
