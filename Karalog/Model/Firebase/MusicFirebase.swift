...
//        await withCheckedContinuation { continuation in
//            db.collection("user").document(id).collection("musicList").getDocuments {
//                (collection, err) in
//                if let _err = err {
...
//    //musicListに追加
//    func addMusic(
//        musicName: String, artistName: String, musicImage: String, time: String, score: Double,
//        key: Int, model: String, comment: String, image: UIImage?,
...
//    //musicDataを追加
//    func addMusicDetail(
//        musicID: String, time: String, score: Double, key: Int, model: String, comment: String,
//        image: UIImage?
//    ) {
...
//                }
//            }
//            manager.musicList[indexPath].data.append(
//                MusicData(
//                    time: time,
//                    score: score,
//                    key: key,
...
//            let storagePath =
//                "gs://karalog-39e53.appspot.com/images/data/\(musicID)\(indexPath).jpeg"
//            dataImageRef = storage.reference(forURL: storagePath)
//
//            let metaData = StorageMetadata()
//            metaData.contentType = "image/jpeg"
...
//
//    //musicDataを削除
//    func deleteMusicDetail(
//        musicID: String, data: MusicData, completionHandler: @escaping (Any) -> Void
//    ) {
//        if let indexPath = manager.musicList.firstIndex(where: { $0.id == musicID }) {
//            let d =
//                [
//                    UserRef.MusicListRef.MusicDataRef.comment.rawValue: data.comment,
...
//                    UserRef.MusicListRef.MusicDataRef.time.rawValue: data.time,
//                ] as [String: Any]
//            musicRef.document(musicID).updateData([
...
//
//                    guard let num = manager.musicList.firstIndex(where: { $0.id!.contains(id) })
//                    else { return }
...
//
//    //listからmusicを削除
//    func deleteMusicFromList(
//        selectedID: String, listID: String, completionHandler: @escaping (Any) -> Void
//    ) {
...
//                guard let num2 = manager.musicList[num1].lists.firstIndex(where: { $0 == listID })
//                else { return }
