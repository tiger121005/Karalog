...
//        guard var getLog = detectString(kind: model) else {
//            return DetectLog(music: "", artist: "", score: "", model: model, comment: "")
//        }
//        getLog.model = model
//        return getLog
//    }
...
//            }
//
//            guard let _results = request.results as? [VNClassificationObservation],
//                let _firstObservation = _results.first
//            else {
//                return
//            }
...
//
//                    guard
//                        let trimedImage = self.trimmingImage(trimmingArea: result.boundingBox)
//                            .cgImage
//                    else {
...
//        return DetectLog(
//            music: musicText, artist: artistText, score: scoreText, model: "", comment: commentText)
//
//    }
//
//    //MARK: - trimmingImage
...
//
//        guard
//            let imgRef = cgImage.cropping(
//                to: CGRect(
//                    x: trimmingArea.minX * image.size.height,
...
//    //文字認識を行う
//    func getString(
//        cgImage: CGImage, completionHandler: @escaping ([VNRecognizedTextObservation]) -> Void
//    ) {
