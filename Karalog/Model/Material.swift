...
extension UIImage {
    static let noImage = UIImage(systemName: "photo")!
    static let starFill = UIImage(systemName: "star.fill")!
    static let star = UIImage(systemName: "star")!
}

extension UIColor {
    static let imageColor = UIColor(red: 252 / 255, green: 122 / 255, blue: 37 / 255, alpha: 1.0)
    static let baseColor = UIColor(red: 38 / 255, green: 38 / 255, blue: 38 / 255, alpha: 1.0)
}

extension Color {
    static let imageColor = Color(uiColor: .imageColor)
    static let baseColor = Color(uiColor: .baseColor)
}

extension TextFieldStyle where Self == SearchTextFieldStyle {
    static var search: SearchTextFieldStyle {
        .init()
    }
}
...
//        guard
//            let starImage = UIImage.starFill.withTintColor(UIColor.imageColor).resized(toWidth: 300)
//        else { return [] }
//
...
//
//        guard
//            let lassoImage = UIImage.lassoAndSparkles.withTintColor(UIColor.imageColor).resized(
//                toWidth: 300)
//        else { return [] }
//
...
//
//        return [
//            Lists(listName: "お気に入り", listImage: starData, id: "favorite"),
...
//
//    let categoryList = [
//        "恋愛", "盛り上がる", "幸せ", "喜び", "悲しい", "失恋", "希望", "切ない", "憧れ", "憂鬱", "懐かしい", "勇気", "不安", "寂しい",
//        "成長", "挫折", "青春", "春", "夏", "秋", "冬", "夢", "怒り", "友情", "純粋", "幻想", "励まされる", "風刺", "情熱",
//        "熱い", "冷たい", "新感覚", "アガる", "エモい", "感謝", "思い出", "面白い", "救われる", "穏やか", "哀愁", "暗い", "明るい",
//        "片思い", "ノリノリ", "怖い", "開放感", "かっこいい", "可愛い",
//    ]
//
//    let noMusicImageURL =
//        "https://s.widget-club.com/samples/4Xo8MX7tM5NRDsSL9BxGgs0vtQt2/9yMsO8MumnSoOb4W58Rt/1F199258-FC7E-4241-B785-269FE34C0A38.jpg?q=70"
//}
//
////MARK: - UIColor
//
