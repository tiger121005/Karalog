...
//            if kind == "past" {
//                guard
//                    let list = await postFB.searchUserPost(first: true, id: userID, name: userName)
//                else { return }
//                self.shareList = list
...
//                        title: "削除",
//                        message: "”" + self.shareList[indexPath.row].musicName + "”" + "を削除しますか",
...
//                    if kind == "past" {
//                        guard
//                            var list = await postFB.searchUserPost(
//                                first: false, id: userID, name: userName)
//                        else { return }
//                        if list.isEmpty {
//                            print("finalContent")
//                            return
...
//                        let newIndePaths = (oldCount..<newCount).map {
...
//                        let newCount = self.shareList.count
//                        let newCountIndexPaths = (oldCount..<newCount).map {
//                            IndexPath(item: $0, section: 0)
//                        }
//                        DispatchQueue.main.async {
