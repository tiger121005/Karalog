...
//
//        self.followNumBtn.configuration?.titleTextAttributesTransformer =
...
//            }
//
//        self.followerNumBtn.configuration?.titleTextAttributesTransformer =
//            UIConfigurationTextAttributesTransformer { incoming in
//                var outgoing = incoming
//                outgoing.font = UIFont.systemFont(ofSize: 25)
//                return outgoing
...
//        menuBtn.image = UIImage.line3Horizontal.withConfiguration(
...
//                        title: "エラー", message: "ユーザーが見つかりません", preferredStyle: .alert)
...
//                            best = list[i]
//                        } else if list[i].data.count == best.data.count
//                            && list[i].data.last!.time > best.data.last!.time
//                        {
//                            best = list[i]
//                        }
//                    }
...
//            }
//
//            let follower = UIAlertAction(title: SettingShow.follower.rawValue, style: .default) {
//                _ in
...
//        case 5:
//            let alert = UIAlertController(
//                title: "画像の送信", message: "画像認識向上のため撮影した採点画面の画像を送信することを許可しますか",
...
//        case 6:
//            let alert = UIAlertController(
//                title: "ログアウト", message: "”Karalog”からログアウトしますか？", preferredStyle: .alert)
