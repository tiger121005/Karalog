...
//    func setupPageView() {
//        guard
//            let followerViewController = storyboard?.instantiateViewController(
//                withIdentifier: "follower") as? FollowerViewController
//        else { return }
//        followerViewController.followerList = followerList
//        followerViewController.delegate = self
//
//        guard
//            let followViewController = storyboard?.instantiateViewController(
//                withIdentifier: "follow") as? FollowViewController
//        else { return }
...
//        } else {
//            pageViewController.setViewControllers(
//                [viewControllers[1]], direction: .forward, animated: false, completion: nil)
//        }
...
//        }
//        segmentedCtl.addTarget(
//            self, action: #selector(segmentChanged(segmentCtl:)), for: UIControl.Event.valueChanged)
//
//    }
//
//    func setup() {
...
//        case 0:
//            pageViewController.setViewControllers(
//                [viewControllers[index]], direction: .reverse, animated: true)
//
//        case 1:
//            pageViewController.setViewControllers(
//                [viewControllers[index]], direction: .forward, animated: true)
//
//        default:
//            break
//        }
