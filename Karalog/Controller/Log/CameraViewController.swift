...
//        label: "com.example.apple-samplecode.CaptureSessionQueue")
...
//            if let newVideoOrientation = AVCaptureVideoOrientation(
...
//        btnImage = btnImage.resized(toWidth: 100) ?? btnImage
...
//            uiRotationTransform = CGAffineTransform(translationX: 1, y: 0).rotated(
//                by: CGFloat.pi / 2)
//        case .landscapeLeft:
//            textOrientation = .up
...
//            uiRotationTransform = CGAffineTransform(translationX: 0, y: 1).rotated(
//                by: -CGFloat.pi / 2)
//        }
//
//        visionToAVFTransform =
//            roiToGlobalTransform
...
//    func setupCamera() {
//        guard
//            let _captureDevice = AVCaptureDevice.default(
...
//        let pinchGestureReconizer: UIPinchGestureRecognizer = UIPinchGestureRecognizer(
//            target: self, action: #selector(onPinchGesture(_:)))
...
//                cvPixelBuffer: _pixelBuffuer, orientation: textOrientation, options: [:])
//            do {
