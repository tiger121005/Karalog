...
//                        title: "削除", message: String(indexPathList.count) + "個の曲のデータを削除します",
...
//                UIImage.SymbolConfiguration(weight: .bold)), menu: selectMenu)
...
//            }
//
//            let delete = UIAction(title: "削除", image: UIImage.trash, attributes: .destructive) {
//                _ in
//
//                //alert
//                let alert = UIAlertController(
//                    title: "削除",
//                    message: "”" + self.cvList[indexPath.row].musicName + "”" + "を削除しますか",
//                    preferredStyle: .alert)
