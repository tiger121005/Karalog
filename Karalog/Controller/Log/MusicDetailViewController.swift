...
//        tableView.register(
//            UINib(nibName: "LogCell", bundle: nil), forCellReuseIdentifier: "logCell")
...
//            rootView: LineMarkView(
//                sampleData: a, max: max, min: min, maxWidth: UIScreen.main.bounds.width - 1))
//
//        self.addChild(vc)
...
//        vc.view.bottomAnchor.constraint(equalTo: graphView.bottomAnchor, constant: 0).isActive =
//            true
...
//
//        guard let d = utility.dateFromString(string: data, format: "yy年MM月dd日HH:mm") else {
//            return "00年00月00日00:00"
//        }
...
//        let cell =
//            tableView.dequeueReusableCell(withIdentifier: "logCell", for: indexPath) as! LogCell
//
//        cell.scoreLabel?.text = String(format: "%.3f", tvList[indexPath.row].score)  //追加の際入力した文字を表示
//        cell.scoreLabel?.textColor = .white
//        cell.detailLabel?.text =
//            tvList[indexPath.row].time + "　　　キー:　" + String(tvList[indexPath.row].key) + "　　　機種:　"
//            + tvList[indexPath.row].model
...
//                    title: "削除できません", message: "データの数を0にすることはできません", preferredStyle: .alert)
//                let ok = UIAlertAction(title: "OK", style: .default)
//                alert.addAction(ok)
//                self.present(alert, animated: true, completion: nil)
//            } else {
//                let alert = UIAlertController(
//                    title: "削除", message: "データを削除します", preferredStyle: .alert)
...
//                    musicFB.deleteMusicDetail(
//                        musicID: self.musicID, data: a,
