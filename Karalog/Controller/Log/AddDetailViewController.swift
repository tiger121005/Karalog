...
//            postFB.post(
//                musicName: musicName, artistName: artistName, musicImage: musicImage,
...
//            $0.musicName == musicName && $0.artistName == artistName
//        }
...
//                musicID: id, time: time, score: Double(scoreTF.text!)!, key: Int(keyLabel.text!)!,
//                model: selectedMenuType.rawValue, comment: textView.text!, image: nil)
//        } else {
//            musicFB.addMusic(
//                musicName: musicName, artistName: artistName, musicImage: musicImage, time: time,
//                score: Double(scoreTF.text!)!, key: Int(keyLabel.text!)!,
//                model: selectedMenuType.rawValue, comment: textView.text!, image: nil,
