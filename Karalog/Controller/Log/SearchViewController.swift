...
//            UINib(nibName: "CollectionViewCell2", bundle: nil),
//            forCellWithReuseIdentifier: "customCollectionCell2")
//
...
//
//        cameraBtn.image = UIImage.camera.withConfiguration(
...
//            let image = response.songs.map {
//                $0.artwork?.url(width: $0.artwork!.maximumWidth, height: $0.artwork!.maximumHeight)
//            }
//            print("Name", name)
//            print("Artist", artist)
//            print("image", image)
...
//
//                    url =
//                        artwork.url(width: width, height: height)?.absoluteString
//                        ?? material.noMusicImageURL
//
//                }
//
//                result.append(
...
//                withReuseIdentifier: "customCollectionCell2", for: indexPath)
...
//                    print(i)
//                    let image =
//                        await UIImage.fromUrl(url: list[i].artworkUrl100) ?? UIImage.musicNote
//
