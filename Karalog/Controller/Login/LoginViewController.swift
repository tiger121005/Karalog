...
//            item: appleLoginButton, attribute: .top, relatedBy: .equal, toItem: loginBtn,
//            attribute: .bottom, multiplier: 1.0, constant: 30)
//        topConstraint.isActive = true
//        let heightConstraint = NSLayoutConstraint.init(
//            item: appleLoginButton, attribute: .height, relatedBy: .equal, toItem: nil,
//            attribute: .notAnAttribute, multiplier: 1.0, constant: 40)
//        heightConstraint.isActive = true
//
//        appleLoginButton.translatesAutoresizingMaskIntoConstraints = false
//
//        appleLoginButton.leftAnchor.constraint(
//            equalToSystemSpacingAfter: googleLoginView.leftAnchor, multiplier: 0
//        ).isActive = true
//        appleLoginButton.rightAnchor.constraint(
//            equalToSystemSpacingAfter: googleLoginView.rightAnchor, multiplier: 0
//        ).isActive = true
//
//        appleLoginButton.addTarget(
//            self, action: #selector(authorizationAppleID), for: .touchUpInside)
//    }
//
//    func makeIndicator() {
...
//            title: "画像の送信", message: "画像認識向上のため撮影した採点画面の画像を送信することを許可しますか", preferredStyle: .alert)
//        let not = UIAlertAction(title: "しない", style: .cancel) { _ in
//            utility.login(
//                first: true,
//                user: User(
//                    name: userName ?? "No Name", goodList: [], listOrder: [], showAll: false,
//                    follow: [], follower: [], request: [], notice: [], getImage: false, id: uid)
//            ) { _ in
...
//                user: User(
//                    name: userName ?? "No Name", goodList: [], listOrder: [], showAll: false,
//                    follow: [], follower: [], request: [], notice: [], getImage: true, id: uid)
//            ) { _ in
//                self.db.collection("user").document(uid).setData([
//                    "name": userName ?? "No Name",
//                    "goodList": [],
...
//                    title: "アカウントが見つかりませんでした", message: err?.localizedDescription,
...
//                    self.activityIndicatorView.stopAnimating()
//                    let dialog = UIAlertController(
//                        title: "アカウントが見つかりませんでした", message: "", preferredStyle: .alert)
//                    dialog.addAction(UIAlertAction(title: "OK", style: .default, handler: nil))
//                    self.present(dialog, animated: true, completion: nil)
//                    if let _error = error {
