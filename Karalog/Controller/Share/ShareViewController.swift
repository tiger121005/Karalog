...
//    @IBOutlet var magnifyingglassBtn: UIBarButtonItem!
...
//            UINib(nibName: "ShareCell", bundle: nil), forCellWithReuseIdentifier: "shareCell")
...
//            self, action: #selector(self.reload), for: UIControl.Event.valueChanged)
...
//        magnifyingglassBtn.image = UIImage.magnifyingglass.withConfiguration(
...
//        Task {
//
//            let list = await postFB.searchPost(
//                first: true, music: musicTF.text ?? "", artist: artistTF.text ?? "",
//                category: category)
//            self.shareList = list
...
//                animations: {
//
//                    self.searchView.center.y =
//                        self.searchView.frame.height / 2
//                        + (self.navigationController?.navigationBar.frame.maxY ?? 44)
//
//                },
...
//            self.searchViewTopConstraint.constant =
//                (self.navigationController?.navigationBar.frame.maxY ?? 44)
//        } else {
//            UIView.animate(
//                withDuration: 0.3,
...
//            return "\(Int(n/100_000_000))億"
//        } else {
//            return "\(Int(n/1_000_000_000_000))兆"
//        }
//    }
//
//    func showMessage() {
...
//    {
//        let cell =
//            collectionView.dequeueReusableCell(withReuseIdentifier: "shareCell", for: indexPath)
//            as! ShareCell
//
...
//        let useImage = resize(image: image, width: 70)
...
//
//                    var list = await postFB.searchPost(
//                        first: false, music: musicTF.text ?? "", artist: artistTF.text ?? "",
//                        category: category)
//                    if list.isEmpty {
//                        finalContent = true
//                        return
...
//
//    func collectionView(
//        collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String,
//        atIndexPath indexPath: NSIndexPath
//    ) -> UICollectionReusableView {
//        if kind == UICollectionView.elementKindSectionFooter {
//            let reusableView = collectionView.dequeueReusableSupplementaryView(
//                ofKind: kind, withReuseIdentifier: "UICollectionReusableView に設定した Idenfier",
...
//
//            let list = await postFB.searchPost(
//                first: true, music: selectedMusic, artist: "", category: [])
//            self.shareList = list
...
//
//            let list = await postFB.searchPost(
//                first: true, music: "", artist: selectedArtist, category: [])
//            self.shareList = list
//            self.musicTF.text = ""
