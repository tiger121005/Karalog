...
//                title: "追加", message: String(indexPathList.count) + "個の曲のデータを追加します",
...
//                        musicFB.addMusicToList(
//                            musicID: idList[i], listID: listID, completionHandler: { _ in })
//                    }
//                } else {
//                    for i in 0..<indexPathList.count {
//                        musicFB.favoriteUpdate(
//                            id: idList[i], favorite: false, completionHandler: { _ in })
//
//                    }
//                }
