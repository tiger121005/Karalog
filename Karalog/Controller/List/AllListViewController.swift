...
//            forCellWithReuseIdentifier: "customCollectionCell1")
...
//        let space = (viewWidth - (160 * 2)) / 3
//        layout.sectionInset = UIEdgeInsets(top: 20, left: space, bottom: 20, right: space)
...
//                        title: "できません", message: "｢お気に入り｣は削除できません", preferredStyle: .alert)
...
//                } else if indexPath.row == 1 {
//                    let alert = UIAlertController(
//                        title: "できません", message: "｢歌いたい｣は削除できません", preferredStyle: .alert)
//                    let cancel = UIAlertAction(title: "OK", style: .default) { (action) in
//
//                    }
//                    alert.addAction(cancel)
...
//                    let alert = UIAlertController(
//                        title: "削除",
//                        message: "”" + manager.lists[indexPath.row].listName + "”" + "を削除しますか",
...
//                withReuseIdentifier: "customCollectionCell1", for: indexPath)
...
//        let destinationIndexPath: IndexPath =
//            destinationIndexPath ?? .init(item: lastItemInFirstSection - 1, section: 0)
