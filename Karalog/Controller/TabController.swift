...
//
//        for i in 0...3 {
//            views[i].tabBarItem = UITabBarItem(
//                title: titles[i],
//                image: images[i].withTintColor(UIColor.gray).withConfiguration(
//                    UIImage.SymbolConfiguration(weight: .bold)),
//                selectedImage: images[i].withTintColor(UIColor.imageColor).withConfiguration(
//                    UIImage.SymbolConfiguration(weight: .bold)))
//        }
//
