...
//
//                        self.listImageRef = self.storageRef.child(
//                            "images/user/\(String(describing: self.userID))/list/\(id).jpeg")
//
//                        self.listImageRef.getData(maxSize: 1 * 1024 * 1024) { data, err in
//                            if let err {
//                                print("Error getting list image: \(err)")
...
//                                    Lists(listName: listName.listName, listImage: data, id: id))
//                            }
//
...
//                                    guard
//                                        let list = manager.lists.first(where: { $0.id!.contains(i) }
//                                        )
//                                    else { continue }
//                                    preList.append(list)
//                                }
...
//                    let artist =
//                        document.data()[UserRef.WannaListRef.artistName.rawValue] as! String
...
//        let storagePath =
//            "gs://karalog-39e53.appspot.com/images/user/\(String(describing: userID))/list/\(ref.documentID).jpeg"
...
//    //wannaListを追加
//    func addWanna(
//        musicName: String, artistName: String, musicImage: String,
...
//        guard let listID = manager.lists[indexPath.row].id else {
//            print("Error delete list")
//            return
//        }
//        listImageRef = storageRef.child(
//            "images/user/\(String(describing: userID))/list/\(listID).jpeg")
//        let storagePath =
//            "gs://karalog-39e53.appspot.com/images/user/\(String(describing: userID))/list/\(listID).jpeg"
//        listImageRef = storage.reference(forURL: storagePath)
//        listRef.document(listID).delete { err in
//            if let err {
//                print("error removing music: \(String(describing: err))")
//                return
//            }
...
//            ]) { err in
//                if let err {
//                    print("Error deleting music order: \(String(describing: err))")
//                    return
//                }
...
//                    if let error {
//                        print("Error delete list image: \(String(describing: error))")
//                        return
//                    }
//
//                }
